...
const PlanningInstrumentView: React.FC = () => {
  ...
  // Fix: Using any as initial value for reduce to avoid "Spread types may only be created from object types" error with Record types using numeric keys.
