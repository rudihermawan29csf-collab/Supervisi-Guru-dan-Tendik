  ...
  return (
    <div className="space-y-4 animate-fadeIn">
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8">
        <h1 className="text-center text-xl font-black uppercase mb-4 border-b-2 border-slate-900 pb-2">Penelaahan ATP</h1>
        ...
        <div className="bg-slate-50 p-4 rounded-xl border mb-6 text-[10px] font-bold">
           <p className="mb-2">Keterangan : Nilai Akhir = Skor Perolehan x 100 % / Skor Maksimal (24)</p>
